defmodule BusiApi.DirectoryTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{firstname: "some firstname", gmail: "some gmail", lastname: "some lastname"}
    @update_attrs %{firstname: "some updated firstname", gmail: "some updated gmail", lastname: "some updated lastname"}
    @invalid_attrs %{firstname: nil, gmail: nil, lastname: nil}
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.gmail == "some updated gmail"
